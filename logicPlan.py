...
def positionLogicPlan(problem) -> List:
    ...
    for t in range(50):
        ...
        if satisfiability:
            return extractActionSequence(satisfiability, actions)
        ...
        for x, y in non_wall_coords:
            axioms = pacmanSuccessorAxiomSingle(x, y, t+1, walls)
            KB.append(axioms)
    "*** END YOUR CODE HERE ***"
...
def foodLogicPlan(problem) -> List:
    ...
    for t in range(50):
        ...
        check_food = []
        for x, y in food:
            check_food.append(PropSymbolExpr(food_str, x, y, time=t))
        satisfiability = findModel(conjoin(conjoin(KB_current), ~disjoin(check_food)))
        ...
        for x, y in food:
            ...
            pac_now = PropSymbolExpr(pacman_str, x, y, time=t)
            KB.append(food_next % conjoin([food_now, ~pac_now]))
    "*** END YOUR CODE HERE ***"
